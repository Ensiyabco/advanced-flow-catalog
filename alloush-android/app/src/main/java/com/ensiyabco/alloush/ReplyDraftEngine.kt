...
object ReplyDraftEngine {
    fun draft(context: Context, message: IncomingMessage, paymentDetails: String): String {
        ...
        return when {
            ...
            text.contains("طلبيه") || text.contains("طلبية") -> "أبشر، أرسل لي الأصناف والكميات اللي تحتاجها وإن شاء الله نخدمك."
            text.contains("شكرا") || text.contains("شكراً") || text.contains("شكر") -> "الشكر لله سبحانه وتعالى، ومن قبل ومن بعد، ونسعد بخدمتكم 🌷"
